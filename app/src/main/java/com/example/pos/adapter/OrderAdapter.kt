...
class OrderAdapter(private val context: Context, private val items: List<MenuItem>, private val listener: OnClickListener, private val addedItemsMap: MutableMap<Int, Item>? )
:RecyclerView.Adapter<OrderAdapter.OrderItemViewHolder>(){
    ...
    override fun onBindViewHolder(holder: OrderItemViewHolder, position: Int) {
        ...
        Log.d(TAG, "addedItems $addedItems")
        if (addedItems != null) {
            if (id in addedItems) {
